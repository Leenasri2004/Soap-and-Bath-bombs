...
const rtlBtnMobile = document.getElementById("rtlToggleMobile");

function toggleRTL(button) {
...
/* DESKTOP BUTTON */
if (rtlBtn) {
  rtlBtn.addEventListener("click", () => toggleRTL(rtlBtn));
}

/* MOBILE BUTTON */
if (rtlBtnMobile) {
  rtlBtnMobile.addEventListener("click", () => toggleRTL(rtlBtnMobile));
}
